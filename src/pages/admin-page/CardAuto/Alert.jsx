...
const Alert = (props) => {
	return(
		<div className={'alert ' + props.message.class}>
			<svg  width="15" height="15" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path  d="M2.75 4.73828L7.16406 0.324219L7.75 0.910156L2.75 5.91016L0.425781 3.58594L1.01172 3L2.75 4.73828Z" fill="white" />
			</svg>
